...
// Componentes estaticamente extraídos para evitar re-renderizações
...
// Badge de médicos online como componente para melhor memoização
...
// Círculos de fundo como componente estaticamente renderizado
...
// SVG da onda inferior como componente
const WaveSVG = memo(() => (
  ...
  return (
    <section className="min-h-screen pt-24 md:pt-28 pb-12 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="section-container relative z-10 flex flex-col lg:flex-row items-center overflow-hidden bg-gradient-to-br from-white to-blue-50 rounded-lg shadow-sm">
        <div className="w-full lg:w-1/2 space-y-6 p-8 lg:p-12 opacity-100">
        ...
        <div className="w-full lg:w-1/2 mt-10 lg:mt-0 opacity-100">
          <div className="relative">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              {/* Badge como componente memoizado */}
              <OnlineBadge />
            </div>
          </div>
        </div>
