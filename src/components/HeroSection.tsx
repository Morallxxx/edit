...
const OnlineBadge = memo(() => (
  <div className="absolute top-2 right-2 md:top-4 md:right-4 bg-white px-3 py-1 md:px-4 md:py-2 rounded-lg shadow-md z-10">
    <div className="flex items-center">
      <div className="h-2 w-2 md:h-3 md:w-3 bg-green-500 rounded-full mr-2" />
...
const BackgroundCircles = memo(() => (
  <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
    <div className="absolute top-10 left-10 w-64 h-64 bg-blue-100 rounded-full opacity-30" />
    <div className="absolute bottom-10 right-10 w-80 h-80 bg-green-100 rounded-full opacity-40" />
  </div>
));

// Onda inferior em SVG
const WaveSVG = memo(() => (
...
const HeroSection = () => {
  return (
    <section className="min-h-screen pt-24 md:pt-28 pb-12 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="section-container relative z-10 flex flex-col lg:flex-row items-center bg-gradient-to-br from-white to-blue-50 rounded-lg shadow-sm overflow-hidden">
        {/* Texto principal */}
        <div className="w-full lg:w-1/2 space-y-6 p-8 lg:p-12">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-a1blue uppercase tracking-tight leading-tight">
          ...
          {/* Benefícios */}
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-8 pt-6 text-sm text-gray-700">
