...
<div className="bg-yellow-100 border-2 border-yellow-300 rounded-xl shadow-md p-6 mt-10 max-w-2xl mx-auto text-center">
  ...
  <a href="https://a1lifesaude.com/#assinar" className="inline-block bg-green-600 hover:bg-green-700 text-white text-lg font-bold py-3 px-6 rounded-full transition duration-300 mb-4">
    🟢 QUERO COMEÇAR AGORA
  </a>
